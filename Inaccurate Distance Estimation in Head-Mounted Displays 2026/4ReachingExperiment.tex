...
To understand how stereo geometry errors in HMDs affect near-field distance perception, we compared participants' blind reaching errors against the stereo triangulation model described in in Section~\ref{sec:model overview}.
